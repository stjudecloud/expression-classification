...
main() {
   ...
   if [ ${#input_counts[@]} -gt 0 ]
   then
      docker run -v $local_output_dir:$container_output_dir -v /stjude/bin:/stjude/bin ghcr.io/stjudecloud/expression-classification:v0.10.2 bash -c "cd $container_output_dir && python /stjude/bin/neighbors.py tsne.txt neighbors.tsv"
